...
#[test]
fn add_ops(){
    let tree: SegmentTree<i32,  AddOps<i32>> = SegmentTree::new(0, 1024);
...
#[test]
fn max_ops(){
    let tree: SegmentTree<i32,  MaxOps<i32>> = SegmentTree::new(0, 1024);
    tree.set_value(5, 1); // a[5] = 1;
    tree.set_value(6, 1); // a[6] = 1;
...
#[test]
fn min_ops(){
    let tree: SegmentTree<i32,  MinOps<i32>> = SegmentTree::new(0, 1024);
    tree.set_value(5, 1); // a[5] = 1;
